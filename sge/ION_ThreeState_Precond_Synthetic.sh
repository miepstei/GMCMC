...
#$ -N ION_ThreeState_Precond_Synthetic
#$ -o /home/ucbpmep/GMCMC/test_Syn_25.out
#$ -e /home/ucbpmep/GMCMC/test_Syn_25.err
...
${MPI_ROOT}/bin/mpirun --mca btl_tcp_if_exclude lo,eth0 -n ${NSLOTS} ./ION_ThreeState_Precond_Synthetic_MH results/ION_ThreeState_Syn_BurnIn_${NSLOTS}_${DATE}.h5 results/ION_ThreeState_Syn_Posterior_${NSLOTS}_${DATE}.h5 --precondition -t ${NSLOTS}
