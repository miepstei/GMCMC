...
#$ -N ION_7STATE_REAL_EXP
#$ -o /home/ucbpmep/GMCMC/ION_7STATE_REAL_EXP.out
#$ -e /home/ucbpmep/GMCMC/ION_7STATE_REAL_EXP.err
...
${MPI_ROOT}/bin/mpirun --mca btl_tcp_if_exclude lo,eth0 -n ${NSLOTS} ./ION_SevenState_10Param_Precond_EXP_MH results/ION_7STATE_REAL_EXP_BurnIn_${NSLOTS}_${DATE}.h5 results/ION_7STATE_REAL_EXP_Posterior_${NSLOTS}_${DATE}.h5 --precondition -t ${NSLOTS}
