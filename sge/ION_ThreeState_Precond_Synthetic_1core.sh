...
#$ -o /home/ucbpmep/GMCMC/onecore.out
#$ -e /home/ucbpmep/GMCMC/onecore.err
...
${MPI_ROOT}/bin/mpirun --mca btl_tcp_if_exclude lo,eth0 -n 1 ./ION_ThreeState_Precond_Synthetic_MH results/ION_ThreeState_Syn_BurnIn_1_${DATE}.h5 results/ION_ThreeState_Syn_Posterior_1_${DATE}.h5 --precondition -t 10
