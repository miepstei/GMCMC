...
#$ -N ION_5STATE_SYNTHETIC_LN
#$ -o /home/ucbpmep/GMCMC/ION_5STATE_SYNTHETIC_LN.out
#$ -e /home/ucbpmep/GMCMC/ION_5STATE_SYNTHETIC_LN.err
...
${MPI_ROOT}/bin/mpirun --mca btl_tcp_if_exclude lo,eth0 -n ${NSLOTS} ./ION_FiveState_8Param_Precond_Synthetic_LN_MH results/ION_5STATE_SYNTHETIC_LN_BurnIn_${NSLOTS}_${DATE}.h5 results/ION_5STATE_SYNTHETIC_LN_Posterior_${NSLOTS}_${DATE}.h5 --precondition -t ${NSLOTS}
