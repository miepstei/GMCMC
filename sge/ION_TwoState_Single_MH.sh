...
${MPI_ROOT}/bin/mpirun --mca btl_tcp_if_exclude lo,eth0 -n ${NSLOTS} ./ION_TwoState_PopMCMC_Single_MH --log10space results/ION_TwoState_Single_BurnIn_${NSLOTS}.h5 results/ION_TwoState_Single_Posterior_${NSLOTS}.h5 -t ${NSLOTS}
