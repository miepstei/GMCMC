...
#$ -o /home/ucbpmep/GMCMC/sixcore.out
#$ -e /home/ucbpmep/GMCMC/sixcore.err
...
${MPI_ROOT}/bin/mpirun --mca btl_tcp_if_exclude lo,eth0 -n 6 ./ION_ThreeState_Precond_Synthetic_MH results/ION_ThreeState_Syn_BurnIn_6_${DATE}.h5 results/ION_ThreeState_Syn_Posterior_6_${DATE}.h5 --precondition -t 10
