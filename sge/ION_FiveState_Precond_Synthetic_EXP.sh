...
#$ -l h_vmem=2G,tmem=2G
#
# Specify a maximum execution time of 2 hour
#$ -l h_rt=2:00:00
#
...
#$ -N ION_5STATE_SYNTHETIC_EXP
#$ -o /home/ucbpmep/GMCMC/ION_5STATE_SYNTHETIC_EXP.out
#$ -e /home/ucbpmep/GMCMC/ION_5STATE_SYNTHETIC_EXP.err
...
${MPI_ROOT}/bin/mpirun --mca btl_tcp_if_exclude lo,eth0 -n ${NSLOTS} ./ION_FiveState_8Param_Precond_Synthetic_EXP_MH results/ION_5STATE_SYNTHETIC_EXP_BurnIn_${NSLOTS}_${DATE}.h5 results/ION_5STATE_SYNTHETIC_EXP_Posterior_${NSLOTS}_${DATE}.h5 --precondition -t ${NSLOTS}
