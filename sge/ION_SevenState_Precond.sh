#!/bin/bash
#
# Script for Seven State model and real Ach data
#
...
#$ -N ION_SevenState_Real_Precond
#$ -o /home/ucbpmep/GMCMC/test_seven_real_25.out
#$ -e /home/ucbpmep/GMCMC/test_seven_real_25.err
...
${MPI_ROOT}/bin/mpirun --mca btl_tcp_if_exclude lo,eth0 -n ${NSLOTS} ./ION_SevenState_10Param_PopMCMC_Precond results/ION_SevenState_Real_BurnIn_${NSLOTS}_${DATE}.h5 results/ION_SevenState_Real_Posterior_${NSLOTS}_${DATE}.h5 --precondition -t ${NSLOTS}
