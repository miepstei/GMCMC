...
#$ -o /home/ucbpmep/GMCMC/twocore.out
#$ -e /home/ucbpmep/GMCMC/twocore.err
...
${MPI_ROOT}/bin/mpirun --mca btl_tcp_if_exclude lo,eth0 -n 2 ./ION_ThreeState_Precond_Synthetic_MH results/ION_ThreeState_Syn_BurnIn_2_${DATE}.h5 results/ION_ThreeState_Syn_Posterior_2_${DATE}.h5 --precondition -t 10
