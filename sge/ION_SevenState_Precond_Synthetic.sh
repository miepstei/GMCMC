...
#$ -N ION_SevenState_Syn_Precond
#$ -o /home/ucbpmep/GMCMC/test_seven_syn_25.out
#$ -e /home/ucbpmep/GMCMC/test_seven_syn_25.err
...
${MPI_ROOT}/bin/mpirun --mca btl_tcp_if_exclude lo,eth0 -n ${NSLOTS} ./ION_SevenState_10Param_Precond_Synthetic_MH results/ION_SevenState_Syn_BurnIn_${NSLOTS}_${DATE}.h5 results/ION_SevenState_Syn_Posterior_${NSLOTS}_${DATE}.h5 --precondition -t ${NSLOTS}
