...
#$ -N ION_FiveState_Syn_Precond
#$ -o /home/ucbpmep/GMCMC/test_five_syn_25.out
#$ -e /home/ucbpmep/GMCMC/test_five_syn_25.err
...
${MPI_ROOT}/bin/mpirun --mca btl_tcp_if_exclude lo,eth0 -n ${NSLOTS} ./ION_FiveState_8Param_Precond_Synthetic_MH results/ION_FiveState_Syn_BurnIn_${NSLOTS}_${DATE}.h5 results/ION_FiveState_Syn_Posterior_${NSLOTS}_${DATE}.h5 --precondition -t ${NSLOTS}
