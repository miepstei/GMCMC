...
${MPI_ROOT}/bin/mpirun --mca btl_tcp_if_exclude lo,eth0 -n ${NSLOTS} ./ION_TwoState_PopMCMC_Single_MH --precondition results/ION_TwoState_Single_BurnIn_Precond_${NSLOTS}.h5 results/ION_TwoState_Single_Posterior_Precond_${NSLOTS}.h5 -t ${NSLOTS}
