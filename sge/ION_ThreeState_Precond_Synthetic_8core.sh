...
#$ -o /home/ucbpmep/GMCMC/eightcore.out
#$ -e /home/ucbpmep/GMCMC/eightcore.err
...
${MPI_ROOT}/bin/mpirun --mca btl_tcp_if_exclude lo,eth0 -n 8 ./ION_ThreeState_Precond_Synthetic_MH results/ION_ThreeState_Syn_BurnIn_8_${DATE}.h5 results/ION_ThreeState_Syn_Posterior_8_${DATE}.h5 --precondition -t 10
