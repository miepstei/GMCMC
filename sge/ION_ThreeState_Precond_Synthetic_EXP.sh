...
#$ -N ION_3STATE_SYNTHETIC_EXP
#$ -o /home/ucbpmep/GMCMC/ION_3STATE_SYNTHETIC_EXP.out
#$ -e /home/ucbpmep/GMCMC/ION_3STATE_SYNTHETIC_EXP.err
...
${MPI_ROOT}/bin/mpirun --mca btl_tcp_if_exclude lo,eth0 -n ${NSLOTS} ./ION_ThreeState_4Param_Precond_Synthetic_EXP_MH results/ION_3STATE_SYNTHETIC_EXP_BurnIn_${NSLOTS}_${DATE}.h5 results/ION_3STATE_SYNTHETIC_EXP_${NSLOTS}_${DATE}.h5 --precondition -t ${NSLOTS}
