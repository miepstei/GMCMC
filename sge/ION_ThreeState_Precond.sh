...
#$ -N ION_ThreeState_Precond
#$ -o /home/ucbpmep/GMCMC/test_25.out
#$ -e /home/ucbpmep/GMCMC/test_25.err
...
${MPI_ROOT}/bin/mpirun --mca btl_tcp_if_exclude lo,eth0 -n ${NSLOTS} ./ION_ThreeState_Precond_MH results/ION_ThreeState_BurnIn_${NSLOTS}_${DATE}.h5 results/ION_ThreeState_Posterior_${NSLOTS}_${DATE}.h5 --precondition -t ${NSLOTS}
