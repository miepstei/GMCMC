...
#$ -o /home/ucbpmep/GMCMC/fourcore.out
#$ -e /home/ucbpmep/GMCMC/fourcore.err
...
${MPI_ROOT}/bin/mpirun --mca btl_tcp_if_exclude lo,eth0 -n 4 ./ION_ThreeState_Precond_Synthetic_MH results/ION_ThreeState_Syn_BurnIn_4_${DATE}.h5 results/ION_ThreeState_Syn_Posterior_4_${DATE}.h5 --precondition -t 10
