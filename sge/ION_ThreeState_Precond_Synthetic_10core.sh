...
#$ -o /home/ucbpmep/GMCMC/tencore.out
#$ -e /home/ucbpmep/GMCMC/tencore.err
...
${MPI_ROOT}/bin/mpirun --mca btl_tcp_if_exclude lo,eth0 -n 10 ./ION_ThreeState_Precond_Synthetic_MH results/ION_ThreeState_Syn_BurnIn_10_${DATE}.h5 results/ION_ThreeState_Syn_Posterior_10_${DATE}.h5 --precondition -t 10
