...
int main(int argc, char * argv[]) {
  ...
  if ((error = parse_options(argc, argv, NULL, ext_longopts,
	...
	fputs("Unable to create priors (not implemented for logspace)\n", stderr);
	MPI_ERROR_CHECK(MPI_Finalize(), "Failed to shut down MPI");
	return -3;
    } else {
        ...
        double max_priors[] = {nap, nap , nap , nap , ap , nap , nap , ap };
    ...
    if (extra.log10space) {
        const double params[] = { 3.308994,3.933353,4.715914,4.072190,8.548747,1.668091,3.156128,8.288648 };
        ...
        const double params[] = { 2037.014843,8577.346614,51989.351991,11808.365750,353790988.087141,46.568402,1432.609378,194378429.864480 };
        if ((error = gmcmc_model_set_params(model, params)) != 0) {
            // Clean up
            free(temperatures);
            gmcmc_burst_dataset_destroy(dataset);
...
static void precondition_covariance(double * M, size_t ldq) {
    if (extra.precondition ){
        //return preconditioned matrix covariance^-1
         M[0 * ldq + 0] = 0.0000509840236787;
        M[0 * ldq + 1] = -0.0000444021403524;
        M[0 * ldq + 2] = 0.0000011939393990;
        M[0 * ldq + 3] = -0.0000140255184591;
        M[0 * ldq + 4] = -0.0000000001640333;
        M[0 * ldq + 5] = 0.0011733738972015;
        M[0 * ldq + 6] = 0.0000047431741213;
        M[0 * ldq + 7] = -0.0000000000089165;
        M[1 * ldq + 0] = -0.0000444021403524;
        M[1 * ldq + 1] = 0.0025283812145553;
        M[1 * ldq + 2] = -0.0001004710358937;
        M[1 * ldq + 3] = 0.0001751384345930;
        M[1 * ldq + 4] = -0.0000000008637728;
        M[1 * ldq + 5] = 0.0059818719737343;
        M[1 * ldq + 6] = 0.0000228878048490;
        M[1 * ldq + 7] = -0.0000000000438670;
        M[2 * ldq + 0] = 0.0000011939393990;
        M[2 * ldq + 1] = -0.0001004710358937;
        M[2 * ldq + 2] = 0.0000048260674288;
        M[2 * ldq + 3] = -0.0000032525604805;
        M[2 * ldq + 4] = 0.0000000000491033;
        M[2 * ldq + 5] = -0.0003545770410247;
        M[2 * ldq + 6] = -0.0000021672101256;
        M[2 * ldq + 7] = 0.0000000000075891;
        M[3 * ldq + 0] = -0.0000140255184591;
        M[3 * ldq + 1] = 0.0001751384345930;
        M[3 * ldq + 2] = -0.0000032525604805;
        M[3 * ldq + 3] = 0.0001458772852118;
        M[3 * ldq + 4] = -0.0000000006772250;
        M[3 * ldq + 5] = 0.0033042110856704;
        M[3 * ldq + 6] = 0.0000160966924508;
        M[3 * ldq + 7] = -0.0000000000409589;
        M[4 * ldq + 0] = -0.0000000001640333;
        M[4 * ldq + 1] = -0.0000000008637728;
        M[4 * ldq + 2] = 0.0000000000491033;
        M[4 * ldq + 3] = -0.0000000006772250;
        M[4 * ldq + 4] = 0.0000000000000248;
        M[4 * ldq + 5] = -0.0000001188395930;
        M[4 * ldq + 6] = -0.0000000010415928;
        M[4 * ldq + 7] = 0.0000000000000043;
        M[5 * ldq + 0] = 0.0011733738972015;
        M[5 * ldq + 1] = 0.0059818719737343;
        M[5 * ldq + 2] = -0.0003545770410247;
        M[5 * ldq + 3] = 0.0033042110856704;
        M[5 * ldq + 4] = -0.0000001188395930;
        M[5 * ldq + 5] = 1.0092726040369147;
        M[5 * ldq + 6] = -0.0035647055830594;
        M[5 * ldq + 7] = 0.0000000023912636;
        M[6 * ldq + 0] = 0.0000047431741213;
        M[6 * ldq + 1] = 0.0000228878048490;
        M[6 * ldq + 2] = -0.0000021672101256;
        M[6 * ldq + 3] = 0.0000160966924508;
        M[6 * ldq + 4] = -0.0000000010415928;
        M[6 * ldq + 5] = -0.0035647055830594;
        M[6 * ldq + 6] = 0.0003945546640420;
        M[6 * ldq + 7] = -0.0000000008639144;
        M[7 * ldq + 0] = -0.0000000000089165;
        M[7 * ldq + 1] = -0.0000000000438670;
        M[7 * ldq + 2] = 0.0000000000075891;
        M[7 * ldq + 3] = -0.0000000000409589;
        M[7 * ldq + 4] = 0.0000000000000043;
        M[7 * ldq + 5] = 0.0000000023912636;
        M[7 * ldq + 6] = -0.0000000008639144;
        M[7 * ldq + 7] = 0.0000000000000072;   
